...
my.iris <- iris
head(my.iris)
my.iris$plant <- as.factor(paste("plant", 1:nrow(my.iris), sep = "")) #created a new column called plant

# gather()
my.iris.long <- gather(my.iris, plant.dimension, 
                       cm, Sepal.Length:Petal.Width) #created a new data frame with 2 new columns 
                  #arg1 - data, arg2 - new column you want with the factor levels
                  #arg 3 - new column where the data goes
                  #arg 4 - columns containing the data you want currently
                  #if they aren't next to each other, can use c(), 

                  #make sure to check that they are still factors - sometimes tidyverse things dont                     like factors
...
my.iris.widedim <- spread(my.iris.long, key = "dimension", value = "cm")
                          #arg 1 - dataframe
                          #arg 2 - pick a factor along which the data will be spread, where your data                           come from
                          #arg3 - the data which will go in the columns
